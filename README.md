...
|:----------------------|:--|
| Tuesday, 11/09/2018 | [**Geometry Processing Pipeline**](lecture-notes/introduction.md), "life of a shape", shapes, surface representations, tangents and normals, geometry vs. topology<br> _Polygon Mesh Processing_ [Botsch et al. 2008] <br> _**[HW 00 assigned](https://github.com/alecjacobson/geometry-processing-introduction) & [Fill in final project choices](https://goo.gl/forms/iCkeHqYRszYyufV42), due 17/09/2018**_
